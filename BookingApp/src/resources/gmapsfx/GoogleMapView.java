...
import resources.gmapsfx.javascript.JavaFxWebEngine;
import resources.gmapsfx.javascript.JavascriptRuntime;
import resources.gmapsfx.javascript.event.MapStateEventType;
import resources.gmapsfx.javascript.object.DirectionsPane;
import resources.gmapsfx.javascript.object.GoogleMap;
import resources.gmapsfx.javascript.object.LatLong;
import resources.gmapsfx.javascript.object.MapOptions;
...
//        filePath = getClass().getResource(s+"resources"+s+"html"+s).toExternalForm();
        ...
        if (mapResourcePath == null) {
            if (debug) {
                htmlFile = filePath+"maps-debug.html";
            } else {
                htmlFile = filePath+"maps.html";
            }
        } else {
